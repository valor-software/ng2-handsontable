...
const config = {
  ...
  entry: {
    ...
    'angular2-handsontable': ['ng2-handsontable'],
  ...
  plugins: [
    ...
    new CopyWebpackPlugin([{from: 'node_modules/handsontable/dist/moment/moment.js', to: 'libs/moment.js'}]),
    new CopyWebpackPlugin([{from: 'node_modules/handsontable/dist/pikaday/pikaday.js', to: 'libs/pikaday.js'}]),
    new CopyWebpackPlugin([{
      from: 'node_modules/handsontable/dist/zeroclipboard/ZeroClipboard.js',
      to: 'libs/ZeroClipboard.js'
    }]),
    // generating html
