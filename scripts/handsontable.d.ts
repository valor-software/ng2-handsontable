...
declare namespace ht {
  ...
  interface Renderer {
    (instance: any, td: Element, row: number, col: number, prop: any, value: any, cellProperties: any): void;
  }
  ...
  interface Renderers {
    ...
    registerRenderer: (rendererName: string, Renderer: any) => void;
  }
  ...
  interface ContextMenu {
    callback?: (key: any, options: any) => void;
